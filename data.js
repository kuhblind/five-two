...
const SEED_EXERCISES = [
  ...
  { id: 'dips', name: 'Dips', group: 'upper', measure: 'reps', bucket: '9-12', pattern: 'push',
    ...
    desc: 'On parallel bars, lower until the elbows hit 90° with a slight forward lean (more chest), then press back to lockout. The kg field = added weight; 0 = bodyweight.' },
  ...
  { id: 'kb_swing', name: 'Kettlebell swing', group: 'mixed', measure: 'reps', bucket: '13-16', pattern: 'swing',
    ...
    desc: 'Hinge and hike the kettlebell (or a dumbbell held by one end) back, then snap the hips forward to float it to chest height. The hips do the work — the arms only guide.' },
  { id: 'kb_clean_press', name: 'KB clean & press', group: 'mixed', measure: 'reps', bucket: '9-12', pattern: 'swing',
    ...
    desc: 'Swing the kettlebell (or a dumbbell) up to the rack position at the shoulder (clean), then press it strictly overhead. Lower, repeat. Per arm.' },
